...
Today, we are releasing the release candidate of core Navigation SDK v.1.0 for Android 🎉 🚀
...
Please review the [developer documentation](https://docs.mapbox.com/android/beta/navigation/overview/#installation) to start building with the Mapbox core Navigation SDK v1.0 for Android.
